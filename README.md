...
| **Chrome-расширение** | Закрывает отвлекающие сайты экраном «Сначала — Математика», по кнопке «Начать» ведёт на сайт для занятий и считает активное время (клики, клавиши, прокрутка). Набрал норму — привычка отмечается сама. |
...
Время идёт, только если одновременно:
- вкладка на экране и окно в фокусе;
- открыт сайт из списка привычки (или вкладка, которую ты сам отметил «для учёбы»);
- за последнюю минуту было движение мыши, клавиатура, прокрутка — или идёт видео.
